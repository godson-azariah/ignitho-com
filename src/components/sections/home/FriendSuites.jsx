...
const TITLE_LINES = {
  'Data Engineering Agentic AI Suite': ['Data Engineering', 'Agentic AI Suite'],
  'Data Analytics Agentic AI Suite': ['Data Analytics', 'Agentic AI Suite'],
  'Trust & Governance Agentic AI Suite': ['Trust & Governance', 'Agentic AI Suite'],
}
