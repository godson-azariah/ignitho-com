    ...
    <section className="px-5 py-16 md:py-24">
      <div className="mx-auto grid max-w-[1320px] items-center gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.92fr)] lg:gap-16">
        <div>
          ...
          <motion.p
            className="mt-6 max-w-[58ch] text-[17px] leading-relaxed text-ignitho-muted max-lg:text-center md:text-[18px] lg:text-[19px]"
            {...rise(0.08)}
          >
            FRIEND isn&apos;t another AI tool. It brings three agentic suites together as one governed
            system that connects enterprise data, trusted governance, and real-time analytics so
          ...
          <motion.p
            className="mt-5 max-w-[58ch] text-[17px] leading-relaxed text-ignitho-muted max-lg:text-center md:text-[18px] lg:text-[19px]"
            {...rise(0.16)}
          >
